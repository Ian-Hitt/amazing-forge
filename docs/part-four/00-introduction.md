...
The first three Parts teach you to build a world and play the game. Part Four is what you keep within arm's reach once you're playing: the quick lookups, the blank sheets to print, the on-the-fly generators for places and people, the story-craft guides for when you want to shape a stronger adventure, and — for the curious — the reasoning behind why the rules are built the way they are.
...
- **Hero Sheet**, **Quest Tracker Sheet**, and **World Forge Worksheet** — blank, ready to print and fill in.
- **Making a Location** and **Making an NPC** — quick generators for the places and people you'll invent on the fly, each built to hand you a hook.
