...
The **Antagonist Track** (always present, Chapter 10) is the dread itself closing in — *the thing getting nearer, the dark getting deeper.* It advances when the heroes **strike a Devil's Bargain** (buy survival on a Miss and let the dread gain — the main driver), when a **Miss comes up doubles,** or when a hero goes **Out of Action** (Chapters 9–10). Its odd boxes are **Bad Guys Close In** beats (show them on-screen); its **last box** is genuinely frightening — the thing reaches you, the night is lost, the place claims another, seeding the next chapter. The drama is the photo-finish — the dread almost upon you at the end. Characterize the dread so each time the bad guys close in, you have something to show: "the humming in the walls is louder now, and it's coming from your room."

### Tempo

**Horror is the slowest burn of the seven — and the slowness *is* the fear.** Don't rush to fill boxes. The scares land because of the long quiet stretches between them; a track that advances every roll has no room left for dread.
...
- **Withhold.** Reveal the threat slowly — explaining everything kills the fear. Trust the table's imagination to build something worse than you could describe.
...
- **Challenges are about *enduring and escaping*** (Chapter 8), not winning a fight: "survive the night," "find the way out," "finish the ritual before it's too late." A filled box is one step closer to dawn or the door.
- **Mind the dial, always.** Check in with the table. If something lands too intense for anyone, dial it back, no questions asked. **Ask the Oracle** (Chapter 11) for the things no one wants to decide on purpose — *is it behind the door?* — and let the dice make the dark genuinely uncertain.
- **Pace the dread.** Long quiet stretches are what make the scares land — alternate calm and spike. Let the table breathe, lull them, *then* take it away.
...
No clue found, the safety shrinking, the dread tightening. That's a Horror scene — and the bell is still down here, somewhere, in the dark.
...
*When a hero builds a Boon (Chapter 13), the **Trigger** is the moment they get to use it. These are the situations a Horror hero shines in — roll **d10** or just pick one. Lock a **Strong** effect (Upgrade, Take the Price) to one of these and it fires **once per Scene** instead of once per Session.*
