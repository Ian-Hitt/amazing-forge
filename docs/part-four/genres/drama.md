...
And the **Antagonist Track** (always present, Chapter 10) is just as real without a monster: it's your **rival's rising influence**, or a **scandal creeping toward exposure**. It advances when you **strike a Devil's Bargain** (force the moment on a Miss and give the rival ground — the main driver), when a **Miss comes up doubles,** or when a hero goes **Out of Action** (Chapters 9–10). Its odd boxes are **Bad Guys Close In** beats (narrate them — a whisper spread, an ally peeled away); its **last box** means you've lost *this* one — the rival wins the seat, the secret breaks — seeding the next Story Arc. The drama is the photo-finish — the rival nearly on top as the vote lands. Name your antagonist as a person or a looming event so each time the bad guys close in, you have something to narrate: "the Duchess smiles; she just locked in the vote you needed."

### Tempo

**Drama is a slow burn — and that's the point.** A turning point in a relationship needs screen time to *earn* it: the look, the hesitation, the line that finally gets said. Don't rush to check boxes. Where an Adventure might clear a Milestone in a single charge, a Drama Milestone often takes a whole scene of circling before it lands — and the circling is the fun.
...
- **Relationships are the dungeon.** Before you start, sketch who wants what from whom — a quick web of crushes, rivalries, debts, and grudges. That map *is* your adventure. Every scene should change at least one line on it: closer, colder, or more complicated.
- **Most scenes are Social Confrontations** (Chapter 8): the track is the shifting mood of the room, and a filled box is ground won — a doubt planted, an ally swayed, a confession pried loose, the crowd turning your way. Build them exactly like any other Challenge; only the fiction changes.
- **Secrets are currency.** Hand them out like treasure. Who knows it, who *wants* it, and what it costs to keep or spend — that's the whole economy of a Drama. A secret nobody can use is just trivia; give every secret a person it could hurt.
- **Let feelings have mechanical weight.** Pay the Price as embarrassment, heartbreak, or a damaged reputation; **Mend** (a friend talking you back up) and **Downtime** (a heart-to-heart, a good cry) are how composure comes back (Chapter 9). When the rules treat a broken trust as seriously as a broken arm, the table does too.
- **Use Ask the Oracle for the things only an NPC knows.** *Does she actually forgive him? Is the rumor true?* When no one at the table has decided and the answer should surprise everyone, ask the dice (Chapter 11). It's how a Co-op Drama keeps secrets even from the players holding them.
- **Make everyone want something this scene.** The fastest cure for a flat Drama is to give each character a clear, small, *opposed* want walking into the room. When wants collide, the scene writes itself.
- **The trap to avoid:** niceness with no stakes. Drama needs *friction* — wants that collide, secrets that can't all stay buried, choices with no clean answer. If everyone's getting along and agreeing, the scene is over; cut to the moment something's about to go wrong, or light a fuse.
...
> **Guide:** Roll it.
> **Player:** Nine — a Weak Hit.
> **Guide:** She takes it. Her hands shake a little. That's a box — she's *listening* now. But pay the price: holding it, she realizes you've had it for months. "You've had this since last spring?" The hurt's right back. **Mark a box, and her guard's up again.** What now?

One roll, one box of progress, and one fresh complication — the relationship moved, and it cost something. That's a Drama scene.
...
- **Magic & Technology →** mostly set dressing here, but one twist (a love potion, a group chat that screenshots everything, a spell that can't lie) can become the whole engine.
...
*When a hero builds a Boon (Chapter 13), the **Trigger** is the moment they get to use it. These are the situations a Drama hero shines in — roll **d10** or just pick one. Lock a **Strong** effect (Upgrade, Take the Price) to one of these and it fires **once per Scene** instead of once per Session.*
