...
<div class="af-sheet" markdown="0">
  ...
  <h3>Readiness</h3>
  <p class="af-hint">Start at 9 (circled). Cross off as it drops — Weak Hit &minus;1, Miss &minus;2. At 0 you're Out of Action and one Asset breaks. <b>Mend</b> (in a Challenge, self or ally): Strong +3 / Weak +2 / Miss &minus;1; no villain surge, can't revive a downed hero. <b>Recovery Scene</b> (fall back to regroup): whole party to full — but the villain surges one box. <b>Downtime</b> (between Stories): full reset + restores Broken Assets. Max 9.</p>
