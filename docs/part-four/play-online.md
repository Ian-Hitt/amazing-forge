...
- **Story Arcs** — the Goal, the size (Episode / Movie), the **Story Arc Track** and **Antagonist Track** (its odd boxes the antagonist's Attacks, its last box their victory), the antagonist, and a numbered Milestone list. Checking a Milestone fills its track box automatically.
