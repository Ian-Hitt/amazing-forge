...
- **Story Arcs** — the Goal, the size (Episode / Movie), the **Story Arc Track** and **Antagonist Track** (its odd boxes where the antagonist Closes In, its last box their victory), the antagonist, and a numbered Milestone list. Checking a Milestone fills its track box automatically.
