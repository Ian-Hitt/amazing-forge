...
- **Running a Challenge:** **Easy = 1 box per player** (Medium = +1, Hard = +2). Take turns (everyone acts before anyone repeats). Each roll: **Strong** fill a box · **Weak** fill a box + Pay the Price · **Miss** no box + Pay the Price. **Fill the track = the obstacle is beaten** — enemies have *no stats*, the track *is* the enemy.
