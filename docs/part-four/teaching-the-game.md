...
| The group is **getting hammered** and wonders if they can bail | **Fall back** & the **Antagonist Track** | *"You can fall back and regroup — lose this scene's progress, but everyone heals up. Two catches: the villain marks a box on their track (fill it and they win), and your Readiness max drops by 1 — so each regroup leaves you a little worse than the last. It all resets when you finish the Story Arc."* |
