...
*At the table:* spend a scene on the ordinary day, let the hero Concepts and Bonds breathe, then drop the inciting trouble and **Start a Story Arc**. The Story Arc Track is fresh and the Antagonist Track is quiet — the antagonist is still just a shadow. Act One ends the moment the heroes *commit* to the adventure.
