...
**First, name your next Milestone.** The fastest fix is to remember what the heroes are actually trying to do right now. Look at your Story Arc Track — what's the next box? The next scene is almost always "a step toward that Milestone." Once you've named it, the obvious next move usually appears on its own.
