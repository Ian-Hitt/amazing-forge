...
**The table.** Sitting down, Maya and Leo settle the two table decisions fast: no Guide — they'll play **Co-op** — and their genre is **Adventure** — a snowy fairy-tale quest. (They could open the Adventure kit in Part Four for ready-made archetypes and story seeds, but tonight they're happy inventing.)
...
### Milestone 1 — Find the Secret Entrance

They start **in media res** — no packing, no tavern. Brave and Snik are already partway up the freezing mountain, snow howling, searching a sheer cliff face for a hidden door.
...
The door grinds open — success — *but* a Weak Hit means he **Pays the Price.** Leo decides the most obvious bad thing: the grinding stone is loud, and somewhere deep in the tunnels a goblin horn answers. They've been heard. **Snik loses 1 Readiness (9 → 8).**
...
> **▶ Rules note.** A Miss fills no box and costs 2 Readiness. Note the price was *both* a knock and lost gear — Readiness covers body, mind, *and* supplies, so losing the potion bag fits perfectly.
...
> **Teaching it to your friends?** You're almost certainly the only one at your table who's read this far — and that's exactly how the game expects it. Flip to **[Teaching the Game](../part-five/teaching-the-game.md)** in Part Five for a one-page reference sheet: the four things to teach before you start, and a trigger list for introducing every other rule at the moment it actually comes up.
