...
## Part A — Building & Winning a Quest
...
- **The two Tracks** — a **Quest Track** with one box per Milestone, and an **Antagonist Track** of equal length drawn right beneath it. The heroes win by filling the top row first; they lose if the bottom row fills first.
...
A Milestone is a **chapter of your movie** — and like a chapter, it's made of several **Scenes** (Chapter 8). A Scene is one beat of play: a quick **Regular Roll** or two, or a full **Challenge**. A Milestone is usually a short string of Scenes building to a payoff — **not** a single Challenge. (Occasionally a small Milestone resolves in one Scene, but the typical one is a little sequence.)
...
**Quick milestone ideas by Quest type.** Stuck for what the steps should be? Pick or riff off these shapes:

- **Rescue:** find the captive's location · get past what's guarding them · break them out · escape with them.
- **Heist:** case the target · get inside · reach the prize · get out clean (or not).
- **Journey:** survive the first leg · cross the major barrier · reach the threshold · arrive changed.
...
Every Quest is a **race between two tracks.** The Quest Track is the heroes' progress; the **Antagonist Track** is the bad guys' progress toward *their* goal, running in parallel. It is a **core part of every Quest**, not an optional add-on — you always draw it, because it's the backbone of the heroes' stay-alive valve (fleeing) and the only way a Quest can be lost.

Think of the Antagonist Track as the villain's *own* Quest. Each of its boxes is one of *their* milestones — the dragon spreading its fire, the rival crew closing on the same treasure, the storm marching toward the city.
...
### Losing & Quitting a Quest Gracefully
...
Then let that answer reshape your setting and spark the **next** Quest — directly or indirectly born from this defeat. The cult completed its ritual: now the sky is wrong and a new Quest is to undo it. The rival crew got the treasure: now they're powerful, and the heroes want it back. A good loss should leave the table *excited* about what happens next, not deflated. Because heroes can't die, "losing" is just the story taking a turn — exactly the kind of turn a great series thrives on.
...
> - The only bridge to the festival washed out this morning; the festival is tonight.
> - A sealed door that's been shut for a hundred years just creaked open from the *inside*.
> - The harvest (or the power, or the water) will run out in three days unless its source is found.
> - A messenger collapses at your feet clutching a map you're not supposed to be able to read.
> - The town's protector — a guardian, a machine, a spirit — has stopped working, and no one will say why.
> - A rival you thought you'd beaten is back, and this time they brought friends.
