...
- A **Season** is a **collection of Stories** that share a throughline — a recurring antagonist, a season-long question, a slow-building relationship. You play a run of Stories, and one of them — an Episode or a Movie — serves as the Season's finale, where the throughline pays off.
