...
When a hero has Growth to spend, they can buy from exactly two things:
...
2. A **Trigger** — when you're allowed to use it. This is the flavorful part, and it's wide open: "in a fight," "while protecting someone," "when I'm reading a crowd." Each **Genre Kit** (Part Four) offers a table of triggers that fit its kind of story.
...
**Generic Triggers any hero can grab** — your genre's kit (Part Four) will have more, and sharper:
